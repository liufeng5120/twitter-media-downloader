...
userFollowersApi = 'https://twitter.com/i/api/graphql/wZdQ5doBkvidH0V3olzzEQ/Following'
...
userFollowersApiPar = '{{"userId":"{}","count":{},"includePromotedContent":false,"withSuperFollowsUserFields":true,"withDownvotePerspective":false,"withReactionsMetadata":false,"withReactionsPerspective":false,"withSuperFollowsTweetFields":true}}'
userFollowersApiPar2 = '{"dont_mention_me_view_api_enabled":true,"interactive_text_enabled":true,"responsive_web_uc_gql_enabled":false,"vibe_tweet_context_enabled":false,"responsive_web_edit_tweet_api_enabled":false,"standardized_nudges_for_misinfo_nudges_enabled":false}'
